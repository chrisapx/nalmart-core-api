...
export const roles: RoleData[] = [
  ...
  },
  {
    ...
    permissions: [
      ...
      'UPDATE_ORDER_STATUS',
      'VIEW_WAREHOUSE_JOB',
      'SELECT_ORDER_FOR_PROCESSING',
      'PICK_WAREHOUSE_ITEM',
      'COMPLETE_PICKING_STAGE',
      'SHIP_CHECK_WAREHOUSE_ITEM',
      'COMPLETE_SHIPPING_STAGE',
      'PACK_WAREHOUSE_ITEM',
      'COMPLETE_PACKING_STAGE',
      'RESOLVE_WAREHOUSE_QA',
  ...
  },
  {
    ...
    description: 'Runs warehouse picking, shipping checks, packing and QA handoff stages',
    permissions: [
      'VIEW_DASHBOARD',
      'VIEW_ORDER',
      'VIEW_ORDER_DETAILS',
  ...
  },
  {
    name: 'Delivery Agent',
    slug: 'delivery-agent',
    description: 'Handles dispatch confirmation, code verification and COD cash confirmation',
    permissions: [
      'VIEW_DASHBOARD',
      'VIEW_ORDER',
      'VIEW_ORDER_DETAILS',
